...
@weighted_loss
def focal_eiou_loss(pred, target, eps=1e-7, gamma=0.5):
    r"""`Implementation of paper `Enhancing Geometric Factors into
    Model Learning and Inference for Object Detection and Instance
    Segmentation <https://arxiv.org/abs/2005.03572>`_.
    Code is modified from https://github.com/Zzh-tju/CIoU.
    ...
    focal_eiou_loss = (1 - ious + rho2/c2 + rhow / cw**2 + rhoh / ch**2) * ious**gamma
...
def eiou_loss(pred, target, eps=1e-7):
    ...
    eiou_loss = (1 - ious + rho2/c2 + rhow / cw**2 + rhoh / ch**2)
...
class FocalEIoULoss(nn.Module):
    ...
    def __init__(self, eps=1e-6, reduction='mean', gamma=0.5, loss_weight=1.0):
